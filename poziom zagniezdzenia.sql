...
select hts_code, (select count(parent.id)-1 from chapter_73 as parent where node.lft between parent.lft and parent.rght) as depth from chapter_73 as node order by node.lft;
